...
public class DownLoadService extends Service {
    ...
    private String url;
    private String DOWNLOADPATH = "/tianguo/apk/";
    ...
    private void initDownManager() {
        ...
        down.setDestinationInExternalPublicDir(DOWNLOADPATH,url.substring(url.indexOf(".cn")+3, url.length()));
        down.setTitle(getResources().getString(R.string.app_name));
        down.setDescription(getResources().getString(R.string.app_name)+"正在下载");
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        String path = Environment.getExternalStorageDirectory().getAbsolutePath()+ DOWNLOADPATH + url.substring(url.indexOf(".cn")+3, url.length());
