...
import com.tianguo.zxz.listener.OnDragVHListener;
import com.tianguo.zxz.listener.OnItemMoveListener;
...
public class ChannelAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements OnItemMoveListener {
    ...
    public ChannelAdapter(Context context, ItemTouchHelper helper, List<TagBean> mMyChannelItems,
